...
void main() {
  ...
  group('Event Message', () {
    ...
    const String eventId =
        'fa19bd8aec0b5c08b6e6c78b68b3530134abb3f9b751a3e3696c80e3020da39a';
    const String sig =
    ...
    const int kind = 1;
    const String tagE =
        '656edc6216203b1a91f129e4166bedb1b7c856825152d6709e74c46eb94d047b';
    const String tagP =
    ...
    test('might be instantiated with fromJson constructor', () {
      final EventMessage message =
          EventMessage.fromJson(jsonDecode(rawEvent) as List<dynamic>);
      expect(message.runtimeType, equals(EventMessage));
      expect(message.id, equals(eventId));
      expect(message.pubkey, equals(publicKey));
